  ...
  <div class="content cart">
    <div class="container h-100">
      <div class="d-flex align-items-center justify-content-between border-bottom py-1 mb-4">
        <a href="#" data-bs-toggle="modal" data-bs-target="#customerModal" type="button">{{ nama_customer }}<i class="fas fa-edit ms-2"></i></a>
        <div class="dropdown">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-start">
          <div class="form-group">
            ...
            <input type="text" name="" id="" v-model="nama_customer" class="form-control" placeholder="" aria-describedby="helpId" />
          </div>
        </div>
